    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            if (!dbContext.Products.Any())
            {
                ...
                dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 50, Inventory = 10 });
                dbContext.Products.Add(new Db.Product() { Id = 4, Name = "CPU", Price = 100, Inventory = 500 });
